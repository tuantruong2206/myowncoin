...
unlocked to sign the nilabit-Qt.app bundle.
...
allowing somebody to distribute a nilabit-Qt.app or nilabit-qt-setup.exe with a valid
...
that the nilabit-qt.exe file inside the installer had not been tampered with.
