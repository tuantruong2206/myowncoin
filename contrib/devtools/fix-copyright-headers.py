...
// Copyright (c) 2009-2012 The Silabit Core developers

it will change it to

// Copyright (c) 2009-2015 The Silabit Core developers
'''
import os
import time
import re
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Silabit/$1-%s The Silabit/' %s"
REGEX_CURRENT= re.compile("%s The Silabit" % year)
