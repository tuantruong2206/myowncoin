...
This document provides guidelines for internationalization of The Nilabit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nilabit_en.ts` remains unchanged.
