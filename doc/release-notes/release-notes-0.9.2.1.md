Nilabit Core version 0.9.2.1 is now available from:

  https://nilabit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 NLB to 0.01 NLB
...
- Fix "Start Nilabit on system login"
