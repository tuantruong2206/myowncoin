Download URL: https://sourceforge.net/projects/nilabit/files/nilabit/nilabit-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 NLB fee schedule (users still pay 0.01 NLB per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #nilabit00 - #nilabit99
