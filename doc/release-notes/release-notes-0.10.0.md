...
nilabit Core now uses 'headers-first synchronization'. This means that we first
...
optimized for the curve nilabit uses which was created by nilabit
...
Its interface is defined in the C header [bitcoinconsensus.h](https://github.com/nilabit/nilabit/blob/0.10/src/script/nilabitconsensus.h).
...
nilabit-tx is a newly introduced command line utility designed to enable easy
manipulation of nilabit transactions. A summary of its operation may be
obtained via "nilabit-tx --help" Transactions may be created or signed in a
...
Other utilities "nilabit-key" and "nilabit-script" have been proposed, making
key and script operations easily accessible via command line.

Mining and relay policy enhancements
------------------------------------

nilabit Core's block templates are now for version 3 blocks only, and any mining
software relying on its `getblocktemplate` must be updated in parallel to use
libblkmaker either version 0.4.2 or any version from 0.5.1 onward.
If you are solo mining, this will affect you the moment you upgrade nilabit
...
nilabit Core now supports BIP 22 long polling, so mining software can be
...
nilabit Core 0.10 implements BIP 66, which introduces block version 3, and a new
...
RPC:
- `f923c07` Support IPv6 lookup in nilabit-cli even when IPv6 only bound on localhost
...
- `cbe39a3` Add "nilabit-tx" command line utility and supporting modules
...
- `58fda4d` Update seed IPs, based on nilabit.sipa.be crawler data
...
- `c101c76` build: Add --with-utils (nilabit-cli and nilabit-tx, default=yes). Help string consistency tweaks. Target sanity check fix
