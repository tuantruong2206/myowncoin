...
http://gitorious.org/nilabit/bitcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix nilabit-Qt notifications under Growl 1.3.
Increase required age of nilabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxNilabit properly when installing nilabit-Qt over it. (Windows)
