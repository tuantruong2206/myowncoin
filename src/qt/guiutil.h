...
#ifndef nilabit_QT_GUIUTIL_H
#define nilabit_QT_GUIUTIL_H
...
/** Utility functions used by the Nilabit Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "nilabit:" URI into recipient object, return true on successful parsing
