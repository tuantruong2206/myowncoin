// Copyright (c) 2013-2015 The Nilabit Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CnilabitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CnilabitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CnilabitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CnilabitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CnilabitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CnilabitAddress(arr[0].get_str()).Get() == demoAddress.Get());
