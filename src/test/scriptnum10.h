...
#ifndef nilabit_TEST_SCRIPTNUM10_H
#define nilabit_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Nilabit Core 0.10.0, for cross-comparison.
 */
public:
